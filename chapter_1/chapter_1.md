...
**参照**: `setting/pain_points.md` の (1) ビジネス要求とエンジニアリングの優先度のずれ、(4) 技術的負債が溜まりすぎて手が動かない、(8) モチベーション・心理的安全性の欠如、(9) 事業/経営レイヤーでの開発生産性の誤解、(10) 開発生産性向上の投資対効果（ROI）が説明できない
