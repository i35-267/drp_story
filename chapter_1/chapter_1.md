...
ベッドから起き上がりキッチンへ向かう。窓際の観葉植物に水をやりながらスマートフォンのSlackアプリを開くと、パキラの葉はまだ青々としている。

**#general** チャンネルにはすでに数件のメッセージが届いている。定時後の同僚からの報告、今日の会議のリマインダー、そして昨日の夜中に飛んできた緊急対応のメッセージだ。

「またバグ対応か...」

湊は今日のタスクを頭の中で整理する。昨日から引き続きのバグ修正、新機能の開発、そして来週のリリースに向けた準備。タスクリストを見るとすでに今日だけで10件以上の項目が並んでおり、朝のうちから気が重くなる。

### 部長からの呼び出し

オフィスに到着しMacBookを開いてコードエディタを起動する。昨日の作業を続ける準備をしていると、突然Slackの通知音が鳴った。

**田中部長** が **#general** でメンションしてきました

> 湊君、ちょっと話があるから会議室A-1に来て

湊は、何の話かもわからないまま会議室A-1へ向かう。廊下を歩きながら、来月の経営会議の話を部長がしていたのを思い出し、胸に嫌な予感が広がった。
...
田中部長の言葉に、湊は返す言葉を探した。経営陣から数字を求められているというが、そもそも開発生産性をどう数値化すればいいのか。頭のなかで、PR数やデプロイ頻度といった言葉が浮かんでは消える。それで経営が納得する「数字」になるのか、自分にもわからなかった。
...
湊は返答に困った。確かに最近開発が思うように進まないことは感じていたが、それを「生産性が低い」と言われても何をどう改善すればいいのかわからず、口を開いても言葉が出てこない。
...
山田の声に他のメンバーも作業の手を止めた。12年のエンジニア経験を持つテックリードの山田はいつも冷静で、湊はその姿を頼もしく思いながら、深呼吸してチーム全員に向き直った。
...
その時、Slackの通知音が再び鳴った。今度は飛鳥さくらPMからのメッセージだった。営業出身で3年前にPMに転身した飛鳥は、いつもこのペースだ。
...
湊の焦りは、その一文を読んだ瞬間に最高潮に達した。部長からの課題も手つかずのまま、ここに緊急案件が重なる。*今でも手一杯なのに...でも生産性を可視化しろと言われたばかりだし...* 
...
湊は深呼吸した。チーム全体が不安を抱えているのだから、リーダーとしてここで冷静に判断しなければならない。
...
なぜ「開発生産性向上」が重圧になるのか。それは**何が問題かが関係者で共有されていない**ときによく現れる構造的な課題とつながっています。
...
この重圧の背景には、**「開発生産性」という言葉の意味が関係者間で共有されていない問題**があります。本質を理解する前に、まず「何が問題なのか」を関係者で揃えるところでつまずいているのです。
...
この認識のズレが、湊が感じた「何をすればいいのかわからない」という重圧の正体です。ソフトウェア工学の古典である Brooks の「No Silver Bullet」や「The Mythical Man-Month」では、ソフトウェアの困難さは「本質的複雑性」と「偶有的複雑性」に分かれるとされています。本質的複雑性として、複雑性・同調性・可変性・不可視性の四つの性質を挙げ、銀の弾丸は存在しないと論じています。一つの指標や手法で開発生産性の課題を一挙に解消できるとは考えない方がよい、という洞察は今でも有効です。
...
湊の違和感はさらに強くなった。しかし「生産性向上」を求められたばかりの湊は反論する勇気が出ず、リーダーとしてチームを守るべきなのに、リーダー3ヶ月目の自分にはまだPMに強く意見する自信がなかった。
...
深夜1時過ぎ、湊は帰宅した。玄関を開けるとリビングのテーブルに昨日のビール缶が2本残っており、冷蔵庫から新しいビールを取り出し一気に飲み干した。窓際のパキラは少し葉が垂れ始めている。水をやる気力も残っていない。
...
湊は山田の言葉を聞いて、改めて問題の本質を考えた。開発が遅れること自体が問題なのではない。なぜ遅れたのか、次はどう変わるのかを **説明できないこと** が問題なのではないか。エンジニアの見積を信じてPMは計画を作るが、毎回遅れる。なぜ遅れるのかは説明されない。リカバリーとして人件費を追加投入するが、コストだけが増えるだけで開発が早くなったかはわからない。この構造的な問題が、湊のチームを苦しめているのではないか。
...
改善策を考えることはできる。でも、その改善策がどれだけの効果をもたらすのか、具体的なROIを説明することはできず、エンジニアの自分には開発生産性向上の投資対効果を経営層が求めているような言葉で説明する方法がわからなかった。
...
湊は改めて考えてみる。開発が遅れること自体が問題なのではない。なぜ遅れたのか、次はどう変わるのかを説明できないことが問題なのではないか。

*つまり、開発生産性の本質は、開発組織が「いつまでに何ができるか」と語った約束が、どれだけ信頼できるかということなのではないか？*

湊はノートに書き出した。開発組織が見ているもの（PR数やデプロイ頻度）と、経営層やPMが見ているもの（計画信頼性・予測可能性）は異なる。こうした指標は開発組織の内部安定性を測るが、事業計画の信頼性は直接測らない。これが、そうした指標が改善しているにもかかわらず、事業責任者・PdMには「良くなった実感」がないギャップの原因なのではないか。
...
この重圧の背景には、**持続不可能な開発がもたらす構造的な問題が顕在化し、「どう変えるべきか」を考える転換点に到達している**という状況があります。認識と深化を経て、ようやく転換を考え始めているのです。Brooks が論じた本質的複雑性の洞察は、持続可能な開発を考えるうえでも有効です。一つの特効薬に頼らず、関係者で定義と測定を合わせ、説明可能な情報を整えていくことが求められます。
