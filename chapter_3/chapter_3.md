...
つまり、内部品質への投資は「コスト」ではなく「将来のコスト削減への投資」として位置づけるべきです。
...
湊は深く頷いた。でも確かに、技術的な課題を財務的な言葉で説明できれば、理解してもらいやすいかもしれない。
...
エンジニアとして、技術的な課題を説明する責任があります。しかし、以下の理由で説明が困難になることがあります。
