...
「開発速度が50%低下しているということは、開発コストが2倍になる。技術的負債の返済に時間をかけることで、長期的なコスト削減につながる」
...
「コスト換算で説明するのはどうでしょうか。先ほど説明したように、開発速度が50%低下しているということは、開発コストが2倍になる。技術的負債の返済に時間をかけることで、長期的なコスト削減につながる」
