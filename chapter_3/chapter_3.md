...
一般的な認識では「高品質なものは高価」というトレードオフがありますが、ソフトウェアの内部品質についてはこの法則が当てはまりません。Martin Fowlerによれば、**高品質なソフトウェアは実際には安く作れる**ことが示されています[^fowler-quality]。
...
開発生産性の本質は「開発組織が『いつまでに何ができるか』と語った約束が、どれだけ信頼できるか」です。これは、単にコードを書く速度やコミット数ではなく、約束した期日に正確に成果物を届けられるかという信頼性を意味します。
