...
開発プロセスの各工程を、AIネイティブな進め方で高速化し、同じ投入工数でより多くの成果物を生み出す戦略。
...
- 新しい価値を作る工数と現状システムを維持する工数を明確に区別できる
...
- 2-1 単なるスピードや数値を超えた生産性の多角的理解と、他者の視点を想像する重要性
...
- ★手法：「人が足りないと言われたときの検証チェックリスト」（戦略・技術環境・組織能力の3軸で検証）
...
・**読者への問い**：「人が足りない」と言われたとき、本当に足りないのは人数か、それとも何を作るかの判断や知恵か。一度立ち止まってみてほしい
・今日から始める持続可能な開発への第一歩
...
- **理論・古典**: フレデリック・ブルックス（No Silver Bullet（銀の弾丸はない）, The Mythical Man-Month（人月の神話））
