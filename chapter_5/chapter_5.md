...
湊は深く考え込む。リソースは増やせない。でも、開発速度を上げる必要がある。どうすればいいのか。
...
湊は深く頷く。AIエージェントは魔法の杖ではない。でも、適切に使えば、開発量を確保する有効な手段になるかもしれない。
...
その夜、湊は一人オフィスに残っていた。以前に学んだ手法を活用して、過去3ヶ月分の工数データを整理していた。
...
湊は深く頷く。開発生産性ツリーの観点から、AI戦略の効果を明確に説明できる。それに、他部署からの評価も得られている。経営層にも理解してもらえるはずだ。
